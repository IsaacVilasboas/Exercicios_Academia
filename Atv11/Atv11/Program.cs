...
- Faça a leitura pelo teclado dos atributos para instanciar dois livros */
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Console.WriteLine("Digite o ano da publicação no formato DD/MM/AAAA");
                string anoPub = Console.ReadLine();
                Console.WriteLine("Digite a editora do livro: ");
                string editora = Console.ReadLine();

                Livro l = new Livro(titulo, a, anoPub, editora);
                /* l.ExibirInformacoes();
                 l.Emprestar();
                 l.Emprestar();
                 l.ExibirInformacoes();
            ...
            {
                Console.WriteLine("Livro: " + listaLivros[i].titulo);
                Console.WriteLine("Autor: " + listaLivros[i].autor.nome);
            }
